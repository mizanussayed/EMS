...
public static class StudentEndpoints
{
    public static IEndpointRouteBuilder MapStudentEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        group.MapGet("/{id:int}", async (int id, IStudentService studentService) =>
            await studentService.GetByIdAsync(id) is StudentResponseModel student ? Results.Ok(student) : Results.NotFound())
        ...
        group.MapPut("/{id:int}", async (int id, StudentRequestModel update, IStudentService studentService) =>
