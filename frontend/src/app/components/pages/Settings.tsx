...
import { RoleGuard, HasRole } from '../auth/RoleGuard';
        ...
        <HasRole allowedRoles={['admin']}>
          <div className="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-10">
            ...
            <div className="space-y-6">
              ...
              <button className="w-full py-4 bg-[#2D6CDF] text-white rounded-2xl font-black shadow-xl shadow-[#2D6CDF]/20 hover:bg-[#1a4ba8] transition-all active:scale-95">
